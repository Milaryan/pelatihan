                ...
                <form>
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_lengkap" class="form-control" id="nama_lengkap" placeholder="Masukkan nama lengkap" value="{{old('nama_lengkap') ? old('nama_lengkap') : $users->nama_lengkap }}" disabled>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="no_telp" class="form-control" id="no_telp" placeholder="Masukkan no telp" value="{{old('no_telp') ? old('no_telp') : $users->no_telp }}" disabled>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_pos" class="form-control" id="kode_pos" placeholder="Masukkan Kode Pos" value="{{old('kode_pos') ? old('kode_pos') : $users->kode_pos }}" disabled>
                    </div>
                    <div class="form-group">
                        <label for="alamat">Alamat Lengkap</label>
                        <textarea name="alamat" id="alamat" class="form-control" cols="30" rows="3" placeholder="Masukkan alamat lengkap" disabled>{{old('alamat') ? old('alamat_lengkap') : $users->alamat_lengkap}}</textarea>
                    </div>
  
                  <div class="card-footer">
                    {{-- <button type="submit" class="btn btn-primary">Submit</button> --}}
                    <a href="{{ route('users') }}" class="btn btn-primary btn-md">Kembali</a>
                  </div>
                </form>
              </div>
              <!-- /.card -->
